...
public class DevToolController {
    ...
    public ResponseEntity<Map<String, String>> getTestToken(@PathVariable Integer userId) {
        String accessToken = jwtTokenProvider.createAccessToken(userId.toString(), UserType.GENERAL);
        String refreshToken = jwtTokenProvider.createRefreshToken(userId.toString(), UserType.GENERAL);
