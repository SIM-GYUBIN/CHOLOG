      ...
      <nav className="w-full inline-flex justify-end items-center gap-4 py-4">
        <button 
          ...
          className={`flex justify-start items-center gap-2 cursor-pointer ${
            isActive('/project/') && !isActive('/archives') && !isActive('/report') && !isActive('/projectsetting')
        ...
        >
          <div className={` ${
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width={"12px"} height={"12px"} viewBox="0 0 18 18" fill="currentColor">
